...
export const metadata: Metadata = {
  title: 'Aviso Legal – ReformaPro',
  description: 'Aviso legal y condiciones de uso del sitio web de ReformaPro.',
      ...
      <div className="space-y-6 text-gray-700">
        ...
        <section aria-labelledby="titular">
          ...
          <ul className="list-none mt-4 space-y-2">
            <li><strong>Denominación social:</strong> ReformaPro S.L.</li>
            <li><strong>NIF:</strong> B-XXXXXXXX</li>
            <li><strong>Domicilio:</strong> Calle Mayor 1, 28013 Madrid, España</li>
            <li><strong>Teléfono:</strong> +34 900 000 000</li>
            <li><strong>Email:</strong> info@reformapro.es</li>
        ...
        <section aria-labelledby="objeto">
          ...
          <p>
            El presente aviso legal regula el uso del sitio web reformapro.es (en adelante, el &ldquo;Sitio Web&rdquo;),
            del que es titular ReformaPro S.L. La utilización del Sitio Web atribuye la condición de usuario
        ...
        <section aria-labelledby="propiedad">
          ...
          <p>
            ...
            imágenes, logotipos y código fuente— son propiedad de ReformaPro S.L. o de sus licenciantes,
          ...
          <p className="mt-3">
            ...
            dichos contenidos sin la autorización previa y escrita de ReformaPro S.L.
          </p>
        </section>
        ...
        <section aria-labelledby="responsabilidad">
          ...
          <p>
            ReformaPro S.L. no se responsabiliza de los daños y perjuicios que pudieran derivarse del
        ...
        <section aria-labelledby="legislacion">
          ...
          <p>
            Las relaciones entre ReformaPro S.L. y los usuarios de su Sitio Web se regirán por la
